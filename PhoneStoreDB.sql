...
INSERT INTO Products (Name, UnitPrice, Image, AvailableDate, Available, CategoryId, Quantity, Description, ViewCount, Special) VALUES
(N'iPhone 14', 20000000, 'iphone14.jpg', '2023-09-01', 1, 1, 50, N'Điện thoại cao cấp từ Apple', 1500.5, 1),
(N'Samsung Galaxy S23', 18000000, 's23.jpg', '2023-10-15', 1, 1, 30, N'Điện thoại mạnh mẽ từ Samsung', 1200.3, 0),
(N'Google Pixel 7', 16000000, 'pixel7.jpg', '2023-10-01', 1, 1, 40, N'Điện thoại camera đỉnh cao', 950.4, 0),
(N'iPhone 13', 17000000, 'iphone13.jpg', '2022-09-01', 1, 1, 25, N'Phiên bản cũ nhưng chất lượng', 1300.6, 0),
(N'Xiaomi 13', 14000000, 'xiaomi13.jpg', '2023-11-10', 1, 1, 35, N'Điện thoại giá rẻ chất lượng', 1100.0, 0),
(N'AirPods Pro', 5000000, 'airpods.jpg', '2023-11-01', 1, 2, 100, N'Tai nghe không dây chất lượng cao', 800.7, 0),
(N'Wireless Charger', 1500000, 'charger.jpg', '2023-06-01', 1, 2, 200, N'Sạc không dây tiện lợi', 400.2, 0),
(N'Power Bank 20000mAh', 1200000, 'powerbank.jpg', '2023-04-15', 1, 2, 150, N'Sạc dự phòng dung lượng lớn', 300.8, 0),
(N'Phone Case iPhone 14', 500000, 'caseiphone14.jpg', '2023-09-10', 1, 2, 300, N'Ốp lưng chính hãng cho iPhone 14', 250.5, 0),
(N'Screen Protector', 300000, 'screenprotector.jpg', '2023-05-01', 1, 2, 250, N'Miếng dán màn hình chống xước', 200.3, 0);
...
(@User1, '2025-06-11 14:30:00', N'123 Đường A, TP.HCM', 20000000, N'Đơn hàng iPhone 14'),
(@User2, '2025-06-11 14:35:00', N'456 Đường B, Hà Nội', 20500000, N'Đơn hàng iPhone 14 + Wireless Charger'),
(@User3, '2025-06-11 14:40:00', N'789 Đường C, Đà Nẵng', 18000000, N'Đơn hàng Samsung Galaxy S23'),
(@User4, '2025-06-11 14:45:00', N'101 Đường D, Cần Thơ', 5200000, N'Đơn hàng AirPods Pro'),
(@User5, '2025-06-11 14:50:00', N'202 Đường E, Hải Phòng', 1500000, N'Đơn hàng Wireless Charger'),
(@User1, '2025-06-11 15:00:00', N'123 Đường A, TP.HCM', 14000000, N'Đơn hàng Xiaomi 13'),
(@User2, '2025-06-11 15:05:00', N'456 Đường B, Hà Nội', 1700000, N'Đơn hàng Phone Case iPhone 14');
